  ...
  render: function() {
    var commentNodes = this.props.data.map(function(comment, index) {
      return (
        ...
        <Comment player={comment.lastname} key={index}>
  ...
  render: function() {
    return (
      <form className="commentForm" onSubmit={this.handleSubmit}>
        <input type="text" placeholder="Your name" ref="player" />
...
React.renderComponent(
  <CommentBox url="roster.json" pollInterval={2000} />,
